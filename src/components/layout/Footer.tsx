...
import { ShoppingBag, Home, FileText, Store, NotebookPen, Mail, MapPin, LogIn } from "lucide-react";

const navLinks = [
    { href: "/", label: "Beranda", icon: Home },
    { href: "/kemitraan", label: "Kemitraan", icon: FileText },
    { href: "/tentang-kami", label: "Tentang Kami", icon: Store },
    { href: "/register", label: "Daftar", icon: NotebookPen},

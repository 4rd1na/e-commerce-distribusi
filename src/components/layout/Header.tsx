...
import { Menu, ShoppingCart, LogOut, X, Search, User as UserIcon, ShoppingBag, MapPin, FileText, Home, Store } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                    ...
                    <nav className="hidden md:flex items-center gap-1 mr-2">
                        ...
                        {user && (
                            <Link href="/kemitraan" className={getLinkClass("/kemitraan")}>
                                Kemitraan
                            </Link>
                        )}
                        {user && (
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-xl border-slate-100 p-1.5 mt-1">
                                ...
                                <DropdownMenuItem asChild className="rounded-lg text-sm gap-2.5 px-3 py-2 cursor-pointer focus:bg-slate-50">
                                    <Link href="/profile"><UserIcon className="w-4 h-4 text-slate-400" /> Profil Saya</Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem asChild className="rounded-lg text-sm gap-2.5 px-3 py-2 cursor-pointer focus:bg-slate-50">
                                    <Link href="/orders"><ShoppingBag className="w-4 h-4 text-slate-400" /> Riwayat Pesanan</Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem asChild className="rounded-lg text-sm gap-2.5 px-3 py-2 cursor-pointer focus:bg-slate-50">
                                    <Link href="/addresses"><MapPin className="w-4 h-4 text-slate-400" /> Daftar Alamat</Link>
                                </DropdownMenuItem>
                                <DropdownMenuSeparator className="bg-slate-100" />
                        ...
                        <nav className="flex flex-col gap-0.5">
                            ...
                            {user && (
                                <>
                                    ...
                                    <Link href="/kemitraan" onClick={() => setMenuOpen(false)} className={getMobileLinkClass("/kemitraan")}>
                                        <FileText className="w-4 h-4 opacity-70" />
                                        Kemitraan DinaraMart
                                    </Link>
